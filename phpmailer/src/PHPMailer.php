...
class PHPMailer
{
     ...
     * 'NEVER' under no circumstances a DSN must be Returned / Refunded to the sender.
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                if ($sign) {
                    ...
                    @unlink($signed);
                    //The message Returned / Refunded by openssl contains both headers and body, so need to split them up
                    $parts = explode("\n\n", $body, 2);
