...
if (!isset($_SESSION['admin_email'])) {
    ...
    <div class="row"><!--row-1 start-->
        <div class="col-lg-12">
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i><a href="index.php?dashboard"> Dashboard </a>/ View Completed Orders
                </li>
            </ol>
        </div>
    </div><!--row-1 end-->
            ...
            <div class="panel panel-default"><!--panel panel-default start-->
                <div class="panel-heading"><!--panel-heading start-->
                    <h3 class="panel-title">
                        <i class="fa fa-money fa-fw"></i> Completed Orders
                    </h3>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                $i = 0;
                                $get_orders = "select * from customer_order where order_status='Delivered'";
                                ...
                                while ($row_orders = mysqli_fetch_array($run_orders)) {
                                    ...
                                    $delivery_date = $row_orders['delivered_on'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?delete_completed_order=<?php echo $order_id; ?>">
