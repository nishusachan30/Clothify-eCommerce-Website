    ...
    <div class="row"><!-- 1 row Starts -->
        <div class="col-lg-12"><!-- col-lg-12 Starts -->
            <ol class="breadcrumb"><!-- breadcrumb Starts -->
                <li class="active">
                    <i class="fa fa-dashboard"></i><a href="index.html?dashboard"> Dashboard </a>/ View Manufacturers
                </li>
            </ol><!-- breadcrumb Ends -->
        </div><!-- col-lg-12 Ends -->
    </div><!-- 1 row Ends -->
                            ...
                            <tbody><!-- tbody Starts -->
                                ...
                                while ($row_manufacturers = mysqli_fetch_array($run_manufacturers)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?delete_manufacturers=<?php echo $manufacturer_id; ?>">
                                                <i class="fa fa-trash-o"></i> Delete
                                            </a>
                                        </td>
                                        <td>
                                            <a href="index.php?edit_manufacturers=<?php echo $manufacturer_id; ?>">
